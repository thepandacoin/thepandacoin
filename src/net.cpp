...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Thepandacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"thepandacoin.com", "thepandacoin.com"},
    {"eu.thepandacoin.com", "eu.thepandacoin.com"},
    {"asia.thepandacoin.com", "asia.thepandacoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Thepandacoin is probably already running."), addrBind.ToString().c_str());
        else
